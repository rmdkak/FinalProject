...
export const Event = () => {
  ...
  return (
    <div className="flex-column w-[1280px] mx-auto my-20 ">
      ...
      <div className="gap-10 px-10 py-10 border-b flex-column border-gray05">
        <img src="" alt="contentImg" className=" bg-gray05 w-[1200px] h-auto" />
        <pre className="w-full break-words whitespace-pre-wrap ">content</pre>
      </div>
      <button
        className="w-40 h-12 my-20 text-sm border rounded-lg border-gray05"
        onClick={() => {
          navigate("/eventlist");
        }}
      >
