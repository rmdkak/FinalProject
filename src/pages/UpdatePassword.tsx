...
export const UpdatePassword = () => {
  ...
  return (
    <section className="flex-column mt-[71px] text-center">
      <h2 className="text-[32px] font-bold">비밀번호 재설정</h2>
      <div className="w-[480px] mx-auto mt-[40px] text-[14px] font-normal">
        <div className="">
          <p>비밀번호 재설정을 위한 본인 확인이 완료되었습니다.</p>
          <p>새로운 비밀번호를 등록 후 사용해주세요.</p>
        </div>
        <form onSubmit={handleSubmit(onSubmit)} action="#" className="mt-[40px] flex-column gap-[24px]">
          <div className="flex items-center gap-[16px] px-[24px] bg-gray08 w-full h-[48px] justify-between ">
          ...
          <button className="w-full text-white py-3 bg-[#888]">변경하기</button>
        </form>
      </div>
    </section>
  );
