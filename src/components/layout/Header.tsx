          ...
          {currentSession === null ? (
            <>
              <div className="flex gap-2 contents-center">
                <button className="sm:w-[24px] xs:w-[24px]" onClick={goToLogin}>
                  <span className="absolute top-[-9999px] left-[-9999px] poindent-[-9999px]">로그인</span>

                  <img src={logOutIcon} alt="로그인" />
                </button>
                <button className="sm:w-[24px] xs:w-[24px]" onClick={openSideBarHandler}>
            ...
            <>
              <div className="flex gap-2 contents-center">
                <button className="sm:w-[24px] xs:w-[24px]" onClick={logoutHandler}>
                ...
                <button className="sm:w-[24px] xs:w-[24px]" onClick={goToMypage}>
