...
const CIRCLE_STYLE = "flex contents-center w-6 h-6 rounded-full text-center text-[12px] font-medium leading-[130%]";
...
export const SignupStep = ({ step }: Props) => {
  return (
    <div className="flex my-6 gap-6">
      <div className="contents-center flex-column gap-3">
