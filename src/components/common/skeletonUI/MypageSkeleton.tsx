  ...
  return (
    <div className="flex-column items-center m-[60px] w-[1280px] h-[2000px] mx-auto">
      ...
      <div className="flex gap-6 mt-8">
        <div className="relative flex-column contents-center bg-gray08 gap-4 w-[225px] h-[200px] rounded-[12px] border border-gray05">
        ...
        <div className="flex items-start border border-gray05 rounded-[12px]">
          {iconArr.map((el) => (
            <div key={el.title} className="relative flex-column contents-center h-full w-[206px] gap-6">
